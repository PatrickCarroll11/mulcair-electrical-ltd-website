...
const HeroSection = () => {
  return (
    <section className="relative min-h-[92vh] flex items-center">
      ...
      <div className="relative container py-32 md:py-36">
        <div className="max-w-3xl">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-black text-white leading-[1.05] tracking-tight mb-6">
            Expert Electrical Services<br />
            in <span className="text-accent">Limerick</span>
          </h1>
          <p className="text-lg md:text-xl text-white/80 mb-10 leading-relaxed max-w-xl">
            Reliable and professional electrical solutions for your home and business.
          </p>
