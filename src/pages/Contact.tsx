      ...
      <section className="bg-primary text-primary-foreground py-20">
        <div className="container">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            Contact <span className="text-accent">Mulcair Electrical Ltd</span>
          </h1>
          ...
          <div className="grid md:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <div className="space-y-5 mb-10">
                <a href="tel:0863722601" className="flex items-center gap-4 group">
                  ...
                  <div>
                    ...
                    <p className="font-semibold">086 3722601</p>
                  </div>
                </a>
                <a href="mailto:mulcairelectricalltd@gmail.com" className="flex items-center gap-4 group">
                  <div className="w-12 h-12 rounded-xl bg-accent/10 flex items-center justify-center group-hover:bg-accent transition-colors">
                  ...
                  <div>
                    ...
                    <p className="font-semibold">mulcairelectricalltd@gmail.com</p>
                  </div>
                </a>
            ...
            <div>
              ...
              <option value="Emergency Electrical Repairs">Emergency Electrical Repairs</option>
              ...
              <option value="Energy Efficient Solutions">Energy Efficient Solutions</option>
                  </select>
                </div>
                <div>
